...
from data.components import normalize_vertices
...
if __name__ == '__main__':
    ...
    for patient_id in tqdm(patient_list):
        ...
        images = output_data["image"][0].get_array()
        labels = output_data["label"][0].get_array()
        point_clouds = output_data["label_point_clouds"]
        template_meshes = output_data["template_meshes"]
        ...
        pio.write_html(fig, file=f"data_test_scotheart-{patient_id}.html")
